...
_BASS_SAMPLES_DIR = f"{_IOWA_SAMPLES_DIR}\\Bass.arco.mono.1644.1"
...
_CELLO_SAMPLES_DIR = f"{_IOWA_SAMPLES_DIR}\\Cello.arco.mono.1644.1"
...
_VIOLA_SAMPLES_DIR = f"{_IOWA_SAMPLES_DIR}\\Viola.arco.mono.1644.1"
_VIOLIN_SAMPLES_DIR = f"{_IOWA_SAMPLES_DIR}\\Violin.arco.mono.1644.1"
